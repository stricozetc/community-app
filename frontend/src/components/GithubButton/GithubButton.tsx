...
import { GithubButtonProps } from './GithubButton.model';
...
export class GithubButton extends React.Component<GithubButtonProps> {
  ...
  public render(): JSX.Element {
    ...
    return (
      <svg
        className='ca-github-button__github-svg'
        viewBox='0 0 250 250'
        aria-hidden='true'
      >
      <a
        className='ca-github-button__github-url'
        href={url}
        aria-label='View source on GitHub'
      >
        <path d='M0,0 L115,115 L130,115 L142,142 L250,250 L250,0 Z' />
        <path
          className='ca-github-button__octo-arm'
