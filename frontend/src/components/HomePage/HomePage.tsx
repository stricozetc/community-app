...
import { CaGameCard } from 'components/GameCard/GameCard';

import { CaFooter } from 'components/Footer';

import userImage from 'assets/user.svg';

import clockImage from 'assets/clock.svg';
import { CaIconWithInfo } from 'components/IconWithInfo';
        ...
        <div className="ca-homepage__container-for-nav">
          ...
          >
            ...
            <div className="ca-navbar__logout-btn-container">
              <Button variant="contained" onClick={() => this.logoutUser()}>
                Logout
              </Button>
            </div>
          </CaNavbar>
                          ...
                          <div className="ca-footer__container-item">
                            <CaIconWithInfo
                              ...
                              secondLine={this.getWaitPlayersCount(
                                this.props.battleStatus,
                                this.props.waitBattlePlayersCountAction,
